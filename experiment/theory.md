...
In Fig. 1, the distance travelled by light wave between the optical flat and test surface at two different locations is (‘uvw’ = <span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">&lambda;</span> / 2 and ‘xyz’ = 3 <span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">&lambda;</span> / 2) is an odd multiple of <span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">&lambda;</span> / 2 and thus destructive interference will occur forming dark fringes. Based on the level of flatness of the test surfaces, the orientation of these dark and bright fringes will differ. 
...
In Fig. 3, two gauges of width, ‘<span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">L</span>,’ and the distance between face 1 and face 2 is <span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">G</span>. An optical flat is placed on both gauges, and &Delta;<span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">H</span> is calculated using the following expression.

$$\Delta H = (n \lambda / 2)(G / L) \tag{1}$$

<span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">n</span> = total no. of fringes

<span style="font-family:'Bodoni MT';font-style:italic;font-size:18px">&lambda;</span> = wavelength of the light
